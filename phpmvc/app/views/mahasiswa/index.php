        ...
        <li class="list-group-item">
           ...
           <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm ('yakin?');">hapus</a>
            <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id']; 
             ...
             data-target="#formModaladd" data-id="<?=$mhs['id']; ?>">ubah</a>
...
<!-- Modal -->
<div class="modal fade" id="formModaladd" tabindex="-1" role="dialog" 
  aria-labelledby="formModalLabel" aria-hidden="true">
    ...
    <input type="hidden" name="id" id="id">
        ...
        <select class="form-control" id="jurusan" name="jurusan">
            ...
            <option value="Teknik Kendaraan Sepeda Motor">Teknik Kendaraan Sepeda Motor</option>
            <option value="Teknik Komputer Jaringan">Teknik Komputer Jaringan</option>
            <option value="Rekayasa Perangkat Lunak">Rekayasa Perangkat Lunak</option>
            <option value="MultiMedia">MultiMedia</option>
            <option value="Agrobisnis Pangan Holtikultura">Agrobisnis Pangan Holtikultura</option>
        </select>
    </div>
